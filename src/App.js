...
function App() {
    ...
    <div className="App">
        ...
        <header className="flex">
          ...
          <a className="logo-link" href="index.html">
            <img className="logo" src={`${process.env.PUBLIC_URL}/assets/logo-white.png`} alt="logo" className="logo"/>
          </a>    
          ...
          <div className="sns-links">
            ...
            <a className="insta" href="https://www.instagram.com/notavgjoenft/" target="_blank">
            ...
            <a className="discord" href="https://discord.gg/TQ4uBkHAjn" target="_blank">
            ...
            <a className="twitter" href="https://twitter.com/NotAvgJoeNFT" target="_blank">
  ...
  <main className="main" className={menuOpen ? "main main-push-down" : "main"}>
    ...
    <div className="container">
      ...
      <p className="text-center fs-500 letter-spacing-5" style={ {lineHeight: "2"} }>
          <span className="strong">"I was an average Joe</span> 
          living in my mom's basement when <span className="strong">
      ...
      <h4 className="fs-500 letter-spacing-4 text-center" style={ {marginBottom: "5em"} }>
          Tell us your story on <a href="https://twitter.com/NotAvgJoeNFT" target="_blank"><u>Twitter</u></a> 
          and <a href="https://discord.gg/TQ4uBkHAjn" target="_blank"><u>Discord</u></a>
      </h4>    

      <div className="text-center" style={ {marginBottom: "4em"} }>
          <a className="text-center fs-400 letter-spacing-3 button strong" 
              href="#mint" id="mint">Minting in January 2022</a>
      </div>
  ...
  <section className="section-five" id="faq">
   <div className="container letter-spacing-1">
      ...
      <div className="questions">Q. When pre-sale & public-sale?
          <li className="answers">Pre-sale: 5PM/8PM PST/EST, January 14 | Public-sale: 5PM/8PM PST/EST, January 15, 2022</li>
      </div>
                      
      <div className="questions">Q. Price?
          <li className="answers">Pre-sale: 0.05 ETH, Public-sale: 0.08 ETH</li>
      </div>
      
      <div className="questions">Q. How many mints per wallet?
          <li className="answers">Three</li>
      </div>
      ...
      <div className="questions">Q. How can I join?
          <li className="answers">We'd love you see you on <a href="https://twitter.com/NotAvgJoeNFT" target="_blank"><u>Twitter</u></a> 
              and <a href="https://discord.gg/TQ4uBkHAjn" target="_blank"><u>Discord</u></a>
          </li>
      </div>
